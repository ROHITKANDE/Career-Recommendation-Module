...
var a = document.forms["form"]["mob"].value;if(a == null || a == ""){alert("Mobile must be filled out");return false;}if(a.length<10 || a.length>10){alert("Entr proper Mobile number.");return false;}
...
<span class="logo"><a href="../index.php">Home</a></span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" maxlength="10" placeholder="Enter your mobile number" class="form-control input-md" type="text" required="">
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <h4 style="font-family:'typo' ">Aurangabad</h4></div></div>
    </p>
      </div>
