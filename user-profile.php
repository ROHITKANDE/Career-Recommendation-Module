...
include('dbconnection.php');
    ...
    if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update user set name ='$name', email='$email', mob='$mob' where id='$userid' ");
     //$query=mysqli_query($con, "update user set name ='name', email='email', mob='mob' where id='$userid' ");
    if ($query) {
  echo "<script>alert('Client has been updated, please login');</script>";
  echo "<script>window.location.href='http://localhost:9090/cr/online/index.php'</script>";
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li class="pull-right"> <a href="https://www.scholarships.com/"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Scholarship</a></li>
						...
						?>
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php  echo $row['mob'];?>" required="true" name="mob" maxlength="10">
								</div>
								<div class="form-group">
									<label>Registration Date</label>
									<input class="form-control" name="regdate" type="text" value="<?php  echo $row['created'];?>" readonly="true">
								</div>
