...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li class="pull-right"> <a href="http://localhost:9090/cr/online/videos.php"><span class="glyphicon glyphicon-stats" aria-hidden="true">
...
<tr style="color:red"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td><td><b>Remark</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
$c++;
echo '<tr><td>'.$c.'</td><td>'.$title.'</td><td>'.$qa.'</td><td>'.$r.'</td><td>'.$w.'</td><td>'.$s.'</td>';
